...
class Freelance_Availability_Widget_Class extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( $currenttime > $available_time_value ) {
			...
			$btext         = isset( $instance['widget_available_button_text'] ) ? $instance['widget_available_button_text'] : __( 'Contact Us', 'freelance-availability-widget' );
			...
			$btext         = isset( $instance['widget_soon_button_text'] ) ? $instance['widget_soon_button_text'] : __( 'Contact Us', 'freelance-availability-widget' );
			...
			$btext = isset( $instance['widget_unavailable_button_text'] ) ? $instance['widget_unavailable_button_text'] : __( 'Contact Us', 'freelance-availability-widget' );
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['widget_available_button_text'] = strip_tags( $new_instance['widget_available_button_text'] );
		...
		$instance['widget_soon_button_text'] = strip_tags( $new_instance['widget_soon_button_text'] );
		...
		$instance['widget_unavailable_button_text'] = strip_tags( $new_instance['widget_unavailable_button_text'] );
  	...
  	* admin control form
  	...
  	function form( $instance ) {
		...
		$available_btext_id     = $this->get_field_id( 'widget_available_button_text' );
		$available_btext_name   = $this->get_field_name( 'widget_available_button_text' );
		...
		$soon_btext_id          = $this->get_field_id( 'widget_soon_button_text' );
		$soon_btext_name        = $this->get_field_name( 'widget_soon_button_text' );
		...
		$unavailable_btext_id   = $this->get_field_id( 'widget_unavailable_button_text' );
		$unavailable_btext_name = $this->get_field_name( 'widget_unavailable_button_text' );
		...
		$available_btext_value   = isset( $instance['widget_available_button_text'] ) ? $instance['widget_available_button_text'] : '';
		...
		$soon_btext_value        = isset( $instance['widget_soon_button_text'] ) ? $instance['widget_soon_button_text'] : '';
		...
		$unavailable_btext_value = isset( $instance['widget_unavailable_button_text'] ) ? $instance['widget_unavailable_button_text'] : '';
		...
		<p><label for="<?php echo $available_btext_id ?>"><?php _e( 'Button Text', 'freelance-availability-widget'  ); ?>: <input type="text" class="widefat" id="<?php echo $available_btext_id; ?>" name="<?php echo $available_btext_name; ?>" value="<?php echo esc_attr( $available_btext_value ); ?>" /></label></p>
		<span class="description"><?php _e( 'If a URL is used, then this will be the button text.', 'freelance-availability-widget' ); ?></p>
		...
		<span class="description"><?php _e( 'Use a shortcode, if you wish, to replace the button with a shortcode.', 'freelance-availability-widget' ); ?></p>
		<p><label for="<?php echo $soon_btext_id ?>"><?php _e( 'Button Text', 'freelance-availability-widget'  ); ?>: <input type="text" class="widefat" id="<?php echo $soon_btext_id; ?>" name="<?php echo $soon_btext_name; ?>" value="<?php echo esc_attr( $soon_btext_value ); ?>" /></label></p>
		<span class="description"><?php _e( 'If a URL is used, then this will be the button text.', 'freelance-availability-widget' ); ?></p>
		...
		<span class="description"><?php _e( 'Use a shortcode, if you wish, to replace the button with a shortcode.', 'freelance-availability-widget' ); ?></p>
		<p><label for="<?php echo $unavailable_btext_id; ?>"><?php _e( 'Button Text', 'freelance-availability-widget'  ); ?>: <input type="text" class="widefat" id="<?php echo $unavailable_btext_id; ?>" name="<?php echo $unavailable_btext_name; ?>" value="<?php echo esc_attr( $unavailable_btext_value ); ?>" /></label></p>
		<span class="description"><?php _e( 'If a URL is used, then this will be the button text.', 'freelance-availability-widget' ); ?></p>
