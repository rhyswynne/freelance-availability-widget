...
function faw_enqueue_datepicker() {
	...
	wp_enqueue_style( 'jquery-ui-structure', FAW_PLUGIN_URL . '/css/jquery-ui.structure.min.css' );
	wp_enqueue_style( 'jquery-ui-theme', FAW_PLUGIN_URL . '/css/jquery-ui.min.css' );
